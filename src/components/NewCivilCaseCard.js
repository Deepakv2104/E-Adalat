  ...
  return (
    ...
    >
      ...
      <Form onSubmit={handleSubmit}>
        ...
        <FormGroup>
          <Label for="defendants_Attorney">Plaintiff's Attorney: </Label>
          <Input
            id="defendants_Attorney"
            name="defendants_Attorney"
            //placeholder="with a placeholder"
            type="defendants_Attorney"
            value={formData.defendants_Attorney}
            onChange={handleChange}
          />
        </FormGroup>
        <FormGroup>
